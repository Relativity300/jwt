...
const { validatorPath, EmailExisting, IdentificationExisting } = require('../middlewares/provedores')

const { getUser, postUser, putUser, deleteUser, GetUserById} = require('../controllers/provedoresController');
...
route.post('/', [ 
    ...
    check('empresa','no puede estar vacio').not().isEmpty(),
    check('codiempresa','tiene que ser numero').isInt(),
